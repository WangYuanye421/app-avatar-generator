  ...
  styles: [
    {
      ...
      previewImage: '/styles/none.png'
    },
    {
      value: 'chibi',
      label: '二头身',
      description: '风格描述：可爱的Q版角色，头部比例较大，身体短小，常用于表现萌系角色',
      previewImage: '/styles/chibi.png'
    },
    {
      value: 'pixel-art',
      label: '像素艺术',
      description: '风格描述：使用像素点组成图像，具有复古游戏的视觉效果',
      previewImage: '/styles/pixel-art.png'
    },
    {
      value: 'cyberpunk',
      label: '赛博朋克',
    ...
    },
    {
      ...
      previewImage: '/styles/fantasy.png'
    },
    {
      value: 'steampunk',
      label: '蒸汽朋克',
      description: '风格描述：维多利亚时代风格与蒸汽动力机械的结合',
      previewImage: '/styles/steampunk.png'
    },
    {
      value: 'anime',
      label: '动漫',
    ...
    },
    {
      ...
      previewImage: '/styles/digital-art.png'
    },
    {
      value: 'comic-book',
      label: '漫画书',
      description: '风格描述：类似传统漫画书的视觉效果，鲜明的线条和色块',
      previewImage: '/styles/comic-book.png'
    },
    {
      value: '3d-model',
      label: '3D模型',
      description: '风格描述：具有三维渲染效果，看起来像计算机生成的3D图像',
      previewImage: '/styles/3d-model.png'
    },
    {
      value: 'photographic',
      label: '摄影',
      description: '风格描述：模拟真实摄影效果，注重光影和细节表现',
      previewImage: '/styles/photographic.png'
    }
  ]
};